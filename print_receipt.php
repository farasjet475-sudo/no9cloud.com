...
if (empty($_SESSION['pos_print_receipt']) || !is_array($_SESSION['pos_print_receipt'])) {
    flash('error', 'No receipt data found.');
    redirect('pos.php');
}

$doc = $_SESSION['pos_print_receipt'];
...
<head>
<meta charset="utf-8">
<title>Receipt - <?php echo e($doc['doc_no'] ?? ''); ?></title>
...
.topbar{height:8px;background:linear-gradient(90deg,#16a34a,#22c55e,#2563eb)}
.inner{padding:30px}
...
.badge{display:inline-block;padding:10px 16px;border-radius:999px;font-weight:800;font-size:13px;color:#fff;background:linear-gradient(135deg,#16a34a,#15803d);text-transform:uppercase;letter-spacing:.5px}
...
.btn-print{background:linear-gradient(135deg,#16a34a,#15803d)}
...
<div class="sheet">
    ...
    <div class="inner">
        <div class="header">
            ...
            <div><div class="badge">Receipt</div></div>
        </div>
